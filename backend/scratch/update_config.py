...
class Settings(BaseSettings):
    ...
    def get_database_url(self) -> Union[URL, str]:
        \"\"\"Construct safe database URL object using URL.create from individual parameters.\"\"\"
...
target_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "../app/config.py"))
