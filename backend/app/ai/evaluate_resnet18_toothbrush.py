"""
VisionInspect AI
Toothbrush ResNet18 Evaluation
...
def build_model():
    ...
    # Exact architecture used by the trained
    # ResNet18 category models:
    #
    # fc.0 = Dropout
    # fc.1 = Linear(512, 2)
...
def load_model():
    ...
    if not MODEL_PATH.exists():
        ...
        raise FileNotFoundError(
            "\nToothbrush model not found:\n"
            f"{MODEL_PATH}\n"
        )

    print(
        "Loading Toothbrush ResNet18..."
    )
    ...
    if "fc.1.weight" not in state_dict:
        ...
        raise RuntimeError(
            "\nToothbrush checkpoint architecture mismatch.\n\n"
            "Expected:\n"
            "  fc.0 = Dropout\n"
            "  fc.1 = Linear(512, 2)\n"
        )
    ...
    if actual_shape != expected_shape:
        ...
        raise RuntimeError(
            "\nToothbrush classifier shape mismatch.\n"
    ...
    if missing or unexpected:
        ...
        raise RuntimeError(
            ...
            "match the expected Toothbrush architecture."
        )
...
def main():
    ...
    if errors:
        ...
        for error in errors:
            ...
            print(
                f"{error['filename']:<15}"
                f"Actual={error['actual']:<15}"
                f"Predicted={error['predicted']:<15}"
                f"Confidence="
    ...
    print("=" * 90)
    print(
        "FINAL TOOTHBRUSH RESNET18 VERDICT"
    )
    print("=" * 90)

    if (
        binary_accuracy >= 0.90
        and binary_precision >= 0.90
        and binary_recall >= 0.90
        and binary_f1 >= 0.90
    ):

        print(
            "✓ TOOTHBRUSH RESNET18 PASSES"
        )
        ...
        print(
            "✓ PRECISION TARGET PASSED"
        )

        print(
            "✓ RECALL TARGET PASSED"
        )
    ...
    print("=" * 90)
    print(
        "TOOTHBRUSH EVALUATION COMPLETE"
    )
    print("=" * 90)
