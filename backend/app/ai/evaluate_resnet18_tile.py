...
def build_model():
    ...
    # Exact classifier used by the trained model:
    #
    # fc.0 = Dropout
    # fc.1 = Linear(512, 6)
...
def load_model():
    ...
    if not MODEL_PATH.exists():
        ...
        raise FileNotFoundError(
            "\nTile model not found:\n"
            f"{MODEL_PATH}\n"
        )

    print(
        "Loading Tile ResNet18..."
    )
    ...
    if "fc.1.weight" not in state_dict:
        ...
        raise RuntimeError(
            "\nTile checkpoint architecture mismatch.\n\n"
            "Expected:\n"
            "  fc.0 = Dropout\n"
            "  fc.1 = Linear(512, 6)\n"
        )
    ...
    if actual_shape != expected_shape:
        ...
        raise RuntimeError(
            "\nTile classifier shape mismatch.\n"
    ...
    if missing or unexpected:
        ...
        raise RuntimeError(
            ...
            "match the expected Tile architecture."
        )
