...
async def create_batch_from_files(
    ...
    line_name: str = "Line 04",
    scanned_by: str = "Quality Engineer",
    ...
    for idx, file in enumerate(files):
        ...
        image_doc = {
            ...
            "bboxUrl": inference_result.get("bboxUrl"),
            "createdAt": now_utc,
            "updatedAt": now_utc
        }
        ...
        model_run_doc = {
            ...
            "modelType": "yolov8_resnet18_unet",
            "modelVersion": "v2.2.0",
            "status": "completed",
            "startedAt": now_utc,
            "completedAt": now_utc,
        ...
        top_defect_item = inference_result.get("defects", [{}])[0] if inference_result.get("defects") else {}
        finding_doc = {
            "_id": finding_id,
            "batchId": batch_code,
            "productId": product_id,
            ...
            "sizeScore": top_defect_item.get("size_score", 0.0),
            "locationScore": top_defect_item.get("location_score", 0.0),
            "defectTypeScore": top_defect_item.get("type_score", 0.0),
            "confidence": conf,
    ...
    batch_doc = {
        ...
        "scannedById": scanned_by_id,
        "createdBy": scanned_by,
        "createdById": scanned_by_id,
